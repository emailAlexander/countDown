...
import { LitElement, html, css, customElement } from '../lib/lit-element.js';
let CountDownHeader = class CountDownHeader extends LitElement {
    _onAdd() {
...
CountDownHeader.styles = css `
    ...
    `;
CountDownHeader = __decorate([
    customElement('cd-header')
], CountDownHeader);
export { CountDownHeader };
